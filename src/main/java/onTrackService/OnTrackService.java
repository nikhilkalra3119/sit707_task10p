...
public Task createTask(String title, String description, String 
creator) { 
...
public Task(int id, String title, String description, String 
creator) { 
            this.id = id; 
            this.title = title; 
 ...
 // Feedback Service 
    public static class FeedbackService { 
        ...
        public Feedback provideFeedback(int taskId, String tutor, String 
comments) { 
            Feedback feedback = new Feedback(feedbackIdCounter++, taskId, 
tutor, comments); 
...
{ 
    ...
    public static class TutoringService { 
        ...
        public Session scheduleSession(String tutor, String student, Date 
date, String time) { 
            Session session = new Session(sessionIdCounter++, tutor, 
student, date, time); 
    ...
    public static class Session { 
        ...
        public Session(int id, String tutor, String student, Date date, 
String time) { 
            this.id = id; 
            this.tutor = tutor; 
    ...
    public static class StudyGroupService { 
        ...
        public StudyGroup createStudyGroup(String groupName, String 
creator) { 
            StudyGroup group = new StudyGroup(groupIdCounter++, groupName, 
creator); 
    ...
    public static class ProgressReport { 
        ...
        public ProgressReport(String student, int averageScore, int 
tasksCompleted) { 
            this.student = student; 
